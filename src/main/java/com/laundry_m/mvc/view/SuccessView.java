...
public class SuccessView {
	...
	public static void printLaundryList(List<Laundry> laundries , List<Double> distances) {
		...
		for(Laundry laundry : laundries) {
			System.out.println( "(" + (i+1) + ") " + laundry.getLaundryId() + distances.get(i) + "km | " + laundry.getLaundryName() + " | " + laundry.getLaundryAddress() + " | " + getLaunTel(laundry.getLaundryTel()) +  " | "  + won.format(laundry.getLaundryDeliveryFee()) + "원" );
	...
	public static void printLaundry(Laundry laundry, double distance) {
		System.out.println( " 고유번호 " +" | " + " 나와의 거리 " + " | " + "    상호명    " + " | " + "     주소     " + " | " + "    연락처    " +  " | "  + "     배달비" );
		System.out.println( distance + " | " + laundry.getLaundryId() + " | " + laundry.getLaundryName() + " | " + laundry.getLaundryAddress() + " | " + getLaunTel(laundry.getLaundryTel()) +  " | "  + won.format(laundry.getLaundryDeliveryFee()) + "원" );
