...
public interface UserDao {
	 ...
	 * @return : User user
	 * */
	User loginUser(String userId, String userPwd) throws SQLException;
	 ...
	 *  @return : List<User> 
	 *  */
	List<User> selectByUserId(User user) throws SQLException;
	 ...
	 *  @return : List<User> 
	 *  */
	List<User> selectByUserType(User user) throws SQLException;	
